    ...
    <Menu
      ...
      <ScrollView
        ...
        maxHeight:heightPercentageToDP(66.12),
          ...
          <>
        <View style={{flexDirection:'row',justifyContent:'space-between',paddingHorizontal:widthPercentageToDP(5),marginTop:heightPercentageToDP(2.85),marginBottom:heightPercentageToDP(3.3),alignItems:'center'}}><Text>Select Language</Text><Icon color={'#CCD4DD'} onPress={onDismiss} size={20}  name='close-circle'/></View>
        <TextInput       onChangeText={text => searchFilterFunction(text)} value={searchQuery}
        placeholder='Filter Languages' underlineColor='transparent' theme={{ colors: { placeholder:'#CCD4DD' ,primary: 'transparent',underlineColor:'transparent',}}}         right={<TextInput.Icon name="magnify"  color='#7B848D' />}
        style={{width:widthPercentageToDP(76.8),backgroundColor:'#fff',borderWidth:1, borderTopRightRadius:9,borderTopLeftRadius:9,borderColor:'#CCD4DD',borderRadius:9,alignSelf:'center',height:heightPercentageToDP(5.83), 
